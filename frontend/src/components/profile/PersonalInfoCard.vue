        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <span
                class="inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium capitalize text-sm bg-success-500 text-white dark:text-white"
                ><!--v-if-->Active<!--v-if--></span
              >
            </div>

            <div>
              <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Last Login</p>
      ...
      <template #body>
        ...
        >
          ...
          <div class="px-2 pr-14">
            ...
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-3">
