        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              ...
              <div>
                <VeeForm :validation-schema="schema" @submit="handleSubmit" class="space-y-5">
                  <div>
                    <label
                      for="username"
                  ...
                  <div>
                    ...
                    <div v-if="error" class="mt-4 text-error-500">
                      {{ error }}
                    </div>
                  </div>
...
// 🛠️ Skema Validasi diubah:
// Menggunakan 'username' sebagai nama field dan menghilangkan validasi email
...
// 🛠️ Handler submit yang menggunakan values.username
const handleSubmit = async (values: any) => {
  error.value = ''
  loading.value = true

  try {
    // Menggunakan values.username dari VeeValidate
    const response = await api.post('auth/login', {
      username: values.username, // Sekarang mengirim field 'username'
